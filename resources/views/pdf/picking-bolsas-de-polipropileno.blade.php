    ...
    <table class="header">
        <tr>
            ...
            <td width="40%" class="title">
                HOJA DE PICKING<br>
                <span style="font-size: 14px; font-weight: normal; text-decoration: none;">(Bolsas de Polipropileno)</span>
            </td>
        ...
        <tbody>
            @foreach($pedido->items as $item)
                @php 
                    ...
                    // Para Bolsas de Polipropileno, la unidad base de picking suelen ser los Fardos
                    $fardosOriginales = (float)($campos['fardo'] ?? 0);
                    $cantidadFinal = ($ajusteQty !== null) ? $ajusteQty : $fardosOriginales;

                    // El Total a despachar en la unidad derivada (Kilos). Calculamos proporcional si se ajusta.
                    ...
                    $umLogistica = $item->producto->unidad_medida_logistica ?: 'UNIDAD';
                @endphp
                <tr>
