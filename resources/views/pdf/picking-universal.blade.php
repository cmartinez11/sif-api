    ...
    <table class="header">
        <tr>
            ...
            <td width="40%" class="title">
                HOJA DE PICKING<br>
                <span style="font-size: 14px; font-weight: normal; text-decoration: none;">(Universal)</span>
            </td>
    ...
    <table class="items-table">
        <thead>
            <tr>
                ...
                <th width="20%" style="background-color: #e6fffa; color: #0f5132; text-align: center; font-size: 10px;">CANTIDAD A DESPACHAR (FARDOS)</th>
            </tr>
        </thead>
        <tbody>
