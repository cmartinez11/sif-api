<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-full mx-auto px-2 md:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                <!-- Logo -->
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <x-application-logo class="block h-20 w-auto fill-current text-gray-600 mb-6" />
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @if(!auth()->user()->hasRole('Logistico'))
                    ...
                    {{-- Solo mostrar si el usuario NO ES LOGISTICO --}}
                    @if(!auth()->user()->hasRole('Logistico'))
