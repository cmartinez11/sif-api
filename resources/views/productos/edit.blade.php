                ...
                <form action="{{ route('productos.update', $producto) }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" min="0.01" name="unidades_por_fardo" id="unidades_por_fardo" value="{{ old('unidades_por_fardo', number_format($producto->unidades_por_fardo, 2)) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-fenix-green focus:ring focus:ring-fenix-green focus:ring-opacity-50">
