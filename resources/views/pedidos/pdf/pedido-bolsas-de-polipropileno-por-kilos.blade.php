...
<head>
    <meta charset="utf-8">
    <title>Pedido de Compra Bolsas de Polipropileno por Kilos - Plásticos Fénix</title>
    <style>
        ...
        <table class="table-items">
            <thead>
                <tr>
                    ...
                    <th style="width: 10%">CANT. FARDOS</th>
                    <th style="width: 5%">U/M</th>
                    <th style="width: 15%">TOT. KILOS</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">{{ $dt->cantidad_fardos ?? 0 }}</td>
                    <td class="text-center">{{ $item->producto?->unidad_medida ?? '-' }}</td>
                    <td class="text-right">{{ number_format($dt->total_kilos ?? 0, 2) }}</td>
